 ...
 *
 * - If out_escape_slash: forwardslash
 *
 * Everything else (should be UTF-8) is just passed through and
 * appended to the result.
 */
static void convert_UTF8_to_JSON(FBuffer *out_buffer, VALUE in_string, bool out_ascii_only, bool out_escape_slash)
{
...
#endif
    convert_UTF8_to_JSON(buffer, obj, state->ascii_only, state->escape_slash);
    fbuffer_append_char(buffer, '"');
}
